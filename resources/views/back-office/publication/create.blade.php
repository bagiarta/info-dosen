<x-layout bodyClass="g-sidenav-show bg-gray-200">
    ...
    <div class="main-content position-relative bg-gray-100 max-height-vh-100 h-100">
        <!-- Navbar -->
        <x-navbars.navs.auth titlePage='Add Publication'></x-navbars.navs.auth>
        <!-- End Navbar -->
            ...
            <div class="card card-body mx-3 mx-md-4 ">
                <div class="card card-plain h-100">
                    ...
                    <div class="card-body p-3">
                        ...
                        @endif
                        <form method='POST' action='{{ route('backoffice.publication.store') }}' enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="mb-3 col-md-6">
                                    ...
                                    <select class="form-control form-select border border-2 p-2" name="user_id" id="" required>
                                        ...
                                        <option class="form-control" value="{{ $dosen->id }}">{{ $dosen->name }}</option>
                                        @endforeach
                                    </select>
                                    @error('user_id')
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <select class="form-control form-select border border-2 p-2" name="publication_category_id" onchange="get_sub_category(this)" id="" required>
                                        ...
                                        <option class="form-control" value="{{ $publication_category->id }}">{{ $publication_category->name }}</option>
                                        @endforeach
                                    </select>
