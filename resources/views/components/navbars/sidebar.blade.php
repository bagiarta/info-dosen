...
<aside
    ...
    <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0 d-flex text-wrap align-items-center" href=" {{ route('backoffice.dashboard') }} ">
            <img src="{{ asset('assets') }}/img/itp.png" class="navbar-brand-img h-100" alt="main_logo">
            <span class="ms-2 font-weight-bold text-white">ITP Markandeya</span>
        </a>
    </div>
    ...
    <div class="collapse navbar-collapse  w-auto  max-height-vh-100" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link text-white {{ $activePage == 'backoffice.dosen.index' ? ' active bg-gradient-success' : '' }} "
                    href="{{ route('backoffice.dosen.index') }}">
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="material-icons opacity-10">dashboard</i>
                    </div>
            ...
            <li class="nav-item">
                <a class="nav-link text-white {{ $activePage == 'backoffice.publication.index' ? ' active bg-gradient-success' : '' }} "
                    href="{{ route('backoffice.publication.index') }}">
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="material-icons opacity-10">dashboard</i>
                    </div>
            ...
            <li class="nav-item">
                <a class="nav-link text-white {{ $activePage == 'backoffice.publication-category.index' ? ' active bg-gradient-success' : '' }} "
            ...
            @if(auth()->user()->role != 'dosen')
            <li class="nav-item">
                <a class="nav-link text-white {{ $activePage == 'backoffice.publication-sub-category.index' ? ' active bg-gradient-success' : '' }} "
            ...
            @endif
            {{-- <li class="nav-item">
                <a class="nav-link text-white {{ $activePage == 'tables' ? ' active bg-gradient-success' : '' }} "
                    href="{{ route('tables') }}">
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
    ...
    {{-- <div class="sidenav-footer position-absolute w-100 bottom-0 ">
        <div class="mx-3">
            <a class="btn bg-gradient-success w-100" href="https://www.creative-tim.com/product/material-dashboard-laravel" target="_blank">Free Download</a>
        </div>
        <div class="mx-3">
            <a class="btn bg-gradient-success w-100" href="../../documentation/getting-started/installation.html" target="_blank">View documentation</a>
        </div>
        <div class="mx-3">
